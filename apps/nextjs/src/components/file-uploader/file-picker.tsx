...
const FilePicker = ({
  ...
  const [filePercentages, setFilePercentages] =
  ...
  const onFileDelete = (index: number) => {
    ...
    setFilePercentages((percentages) =>
      percentages.filter((item, i) => i !== index),
    );
  };

  return (
    <>
      <div className="grid h-full grid-cols-12 justify-between gap-x-5">
        <Files
          className={`${className} col-span-12 flex w-full cursor-pointer items-center md:col-span-6`}
          ...
          clickable
        >
          <div className="w-full rounded-lg border-2 border-dashed border-gray-200/20 bg-zinc-500/10 p-10">
            <svg
        ...
        <div className="col-span-12 h-full w-full pb-10 pt-10 md:col-span-6">
          ...
          {selectedFiles.length > 0 && (
            <div className="h-[23rem] overflow-y-scroll pr-1">
              <AnimatePresence>
          ...
          {selectedFiles.length == 0 && (
            <div className="flex h-full w-full items-center justify-center">
              <div className="text-center">
                ...
                <p className="mt-3 font-medium">Aucun fichier</p>
              </div>
            </div>
          )}
        </div>
